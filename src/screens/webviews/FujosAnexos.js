...
const FlujosAnexos=({navigation,route})=>{
  ...
  getDataFromStorage();
    ...
    const inicio=`https://lizzi.appsholos.com/dev/asignaciones?token_jwt=${token_jwt}&usuario_id=${usuario_id}`
